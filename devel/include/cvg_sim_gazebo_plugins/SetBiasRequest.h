...
bool operator==(const ::cvg_sim_gazebo_plugins::SetBiasRequest_<ContainerAllocator1> & lhs, const ::cvg_sim_gazebo_plugins::SetBiasRequest_<ContainerAllocator2> & rhs)
{
